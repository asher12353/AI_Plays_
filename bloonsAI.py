...
def upgrade(individual, upgrade_index):
    ...
    try:
        ...
        try:
            ...
            upgrade_location = (sell_location[0] + 180, sell_location[1] - 130 - (individual['upgrades'][upgrade_index][1] * 200))
...
try:
    ...
    tower_locations = []
    with open('tower_locations.txt', 'r') as file:
    ...
    tower_types = []
    with open('tower_types.txt', 'r') as file:
        content = file.readlines()
    for line in content:
        individual_chromosome = eval(line)
    ...
    fitness_val = []
    try:
        with open('fitness_val.txt', 'r') as file:
            content = file.readlines()
        for line in content:
    ...
    wants_to_place = []
    try:
        with open('wants_to_place.txt', 'r') as file:
            content = file.readlines()
        for line in content:
            individual_chromosome = eval(line)
    ...
    wants_to_upgrade = []
    try:
        with open('wants_to_upgrade.txt', 'r') as file:
            content = file.readlines()
        for line in content:
            individual_chromosome = eval(line)
...
for generation in range(num_generations):
    ...
    f1 = open("tower_locations.txt", "w")
    f2 = open("tower_types.txt", "w")
    f3 = open("fitness_val.txt", "w")
    f4 = open("upgrades.txt", "w")
    f5 = open("wants_to_place.txt", "w")
    f6 = open("wants_to_upgrade.txt", "w")
